...
Definition arith_sem2 Zfun (D1 D2: EDenote): EDenote :=
  {|
    nrm := arith_sem2_nrm Zfun D1.(nrm) D2.(nrm);
    err := D1.(err) ∪ D2.(err) ∪
...
Module Sets_CL.
Import KleeneFix KTFix Sets_CPO.
